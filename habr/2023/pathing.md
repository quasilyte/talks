...
## Разбор kelindar/tile

Эту библиотеку мне принёс [@sedyh](https://habr.com/ru/users/sedyh/) и она достаточно любопытна.

3 аллокации и ~100000 байтов звучит необычно, давайте разбираться.
